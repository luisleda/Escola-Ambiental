...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'escolaambiental' ); ?></a>
    <?php if (!$hideHeader) { ?>
    <header class="u-clearfix u-header u-header" id="sec-97f4">
  <div class="u-clearfix u-sheet u-valign-middle-xs u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/logoescolaambientalma.png",
            'default_url' => "https://nicepage.com"
        )); $url = stripos($logo['url'], 'http') === 0 ? esc_url($logo['url']) : $logo['url']; ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo $url; ?>" class="u-image u-logo u-image-1 custom-logo-link" data-image-width="150" data-image-height="131">
      <img <?php if ($logo['svg']) { echo 'style="width:'.$logo['width'].'px"'; } ?>src="<?php echo esc_url($logo['src']); ?>" class="u-logo-image u-logo-image-1">
    </a>
    <h6 class="u-align-center-xs u-text u-text-default u-text-1">Escola<br>
      <span style="font-size: 1rem;">Ambiental </span>
      <br>do <br>Maranhão 
    </h6>
    <?php
            ob_start();
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'link_class' => 'u-button-style u-nav-link u-text-active-black u-text-hover-palette-2-base',
                    'link_style' => 'padding: 2px 14px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-4e7c-21',
                ...
                'responsive_menu' => array(
                    ...
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-4e7c-22',
                    'submenu_item_class' => 'u-nav-item',
