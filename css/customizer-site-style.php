...
--custom-color-1: #f1fbfa;
--custom-color-1-darker: #cbf0ec;
--custom-color-1-r: 241;
--custom-color-1-g: 251;
--custom-color-1-b: 250;
--custom-color-1-contrast: black;
--custom-color-1-contrast-darker: black;
--custom-color-1-text-color: var(--body-color);
--custom-color-2: #f0f0f0;
--custom-color-2-darker: #d8d8d8;
--custom-color-2-r: 240;
--custom-color-2-g: 240;
--custom-color-2-b: 240;
--custom-color-2-contrast: black;
--custom-color-2-contrast-darker: black;
--custom-color-2-text-color: var(--body-color);
--custom-color-3: #e6f9f6;
--custom-color-3-darker: #bff0e8;
--custom-color-3-r: 230;
--custom-color-3-g: 249;
--custom-color-3-b: 246;
...
--bg-contrast: var(--body-color);
        ...
        --hyperlink-hover-color: palette-1-base-darker;
        --hyperlink-hover-alt-text-color: grey-30-darker;
        ...
        --button-hover-background-color: palette-1-base-darker;
        --button-hover-color: white-darker;
        --button-hover-alt-background-color: palette-1-light-2-darker;
        --button-hover-alt-color: var(--white);
        --button-hover-background-color: palette-1-base-darker;
        --button-hover-color: white-darker;
        --button-hover-alt-background-color: palette-1-light-2-darker;
        --button-hover-alt-color: var(--white);
        --button-active-background-color: palette-1-base-darker;
        --button-active-color: white-darker;
        --button-active-alt-background-color: palette-1-light-2-darker;
